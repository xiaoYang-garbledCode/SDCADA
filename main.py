...
parser.add_argument('--run_description',        default='EEG_mixup',         type=str, help='name of your runs')
parser.add_argument('--sweep_project',          default='2-HHAR-ECG-Teach_ATT-dev_risk-cotmix_hparams_sweep',     type=str, help='name of your sweep project')
...
# ========= Select the DATASET ==============
parser.add_argument('--dataset',                default='EEG',        type=str, help='Dataset of choice: WISDM, EEG, HAR, HHAR')
